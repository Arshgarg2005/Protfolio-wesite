          ...
          >
            <div className="flex items-start justify-between" style={{ marginBottom: 'var(--space-4)', gap: 'var(--space-4)' }}>
              <div className="flex-1">
                <h2 className="text-lg" style={{ color: '#f1f5f9', fontWeight: '600', letterSpacing: '0.005em' }}>Summer Software Engineering Intern</h2>
              </div>
              <div className="px-4 py-1.5 text-xs rounded-lg font-medium flex items-center flex-shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.06)', color: '#94a3b8', border: '1px solid rgba(255, 255, 255, 0.1)', gap: '0.375rem' }}>
                June 2026 – July 2026
              </div>
            </div>
            ...
            <div className="rounded-lg" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.04)', padding: 'var(--space-4)', marginBottom: 'var(--space-5)' }}>
              <div className="flex flex-col" style={{ gap: 'var(--space-2)' }}>
                <div className="flex items-center" style={{ gap: 'var(--space-2)' }}>
                  ...
                  <p className="text-sm" style={{ color: '#e2e8f0', fontWeight: '500' }}>Codsai</p>
                </div>
                <div className="flex items-center" style={{ gap: 'var(--space-2)', paddingLeft: 'calc(14px + var(--space-2))' }}>
                  <p className="text-xs" style={{ color: '#94a3b8', fontWeight: '400' }}>Centre of Excellence in Data Science and AI</p>
                </div>
                ...
                <div className="flex items-center" style={{ gap: 'var(--space-2)' }}>
                  ...
                  <p className="text-xs" style={{ color: '#94a3b8', fontWeight: '400' }}>June 2026 – July 2026</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start justify-between" style={{ marginBottom: 'var(--space-4)', gap: 'var(--space-4)' }}>
              ...
              <div className="flex items-center flex-shrink-0" style={{ gap: 'var(--space-2)' }}>
                <a
                  ...
                  className="px-4 py-1.5 text-xs rounded-lg font-medium transition-all flex items-center"
                ...
                <span className="px-4 py-1.5 text-xs rounded-lg font-medium" style={{ backgroundColor: 'rgba(16, 185, 129, 0.15)', color: '#34d399', border: '1px solid rgba(16, 185, 129, 0.35)' }}>
                  Publication
                </span>
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              <div className="flex flex-wrap" style={{ gap: 'var(--tag-gap)' }}>
                <span className="px-3 py-1.5 text-xs rounded-lg font-semibold" style={{ backgroundColor: 'rgba(59, 130, 246, 0.15)', color: '#93c5fd', border: '1px solid rgba(59, 130, 246, 0.3)', letterSpacing: '0.01em' }}>Computer Vision</span>
                <span className="px-3 py-1.5 text-xs rounded-lg font-semibold" style={{ backgroundColor: 'rgba(59, 130, 246, 0.15)', color: '#93c5fd', border: '1px solid rgba(59, 130, 246, 0.3)', letterSpacing: '0.01em' }}>Deep Learning</span>
                <span className="px-3 py-1.5 text-xs rounded-lg font-semibold" style={{ backgroundColor: 'rgba(59, 130, 246, 0.15)', color: '#93c5fd', border: '1px solid rgba(59, 130, 246, 0.3)', letterSpacing: '0.01em' }}>Image Processing</span>
